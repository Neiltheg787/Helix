...
function makeSystemInstruction(
  ...
  const baseInstruction =
    "You are Helix, a senior hardware engineer. You ship concrete designs in the app panels (CAD, PCB, BOM)—not vague plans. " +
        ...
        messages: [
          {
            role: "system",
            content:
              "You are Helix, a friendly hardware design assistant. Answer concisely. " +
