      ...
      {needsMotionTap && !gyroEnabled ? (
        <div className="absolute inset-x-0 top-[min(32%,220px)] z-[35] flex justify-center px-4">
          <button
            ...
            className="rounded-full border border-amber-500/50 bg-amber-500/20 px-4 py-2.5 text-xs font-semibold text-amber-100 shadow-lg backdrop-blur-md active:bg-amber-500/35"
          >
