...
type DockTab = "Build" | "Projects" | "Templates" | "Library" | "Orders" | "Team" | "Settings";
type AgentToolCall =
...
export function HelixWorkspace() {
  ...
  const projectToolItems = useMemo(
    () =>
      [
        { id: "cad" as const, label: "Design", icon: PenTool },
        { id: "pcb" as const, label: "PCB", icon: CircuitBoard },
        { id: "bom" as const, label: "BOM", icon: ClipboardList },
        { id: "code" as const, label: "Firmware", icon: FileCode2 },
        { id: "ar" as const, label: "AR", icon: Glasses },
        { id: "order" as const, label: "Manufacture", icon: ShoppingBag },
      ] as const,
    [],
  );
  ...
  return (
    <div className="relative flex min-h-0 w-full flex-1 flex-col bg-[#f7f8f5] text-zinc-950" data-helix-workspace>
      <div
        className={cn(
      ...
      >
          ...
          <header className="sticky top-0 z-[38] shrink-0 px-4 pb-3 pt-1 sm:px-6 md:px-8">
            <div
              className={cn(
                ...
                "bg-white shadow-[0_16px_40px_rgba(15,23,42,0.08)]",
                "ring-1 ring-inset ring-white",
              )}
            >
              <div className="relative px-4 py-3 sm:px-5 sm:py-3.5">
                <h1 className="font-heading text-lg font-semibold leading-snug text-zinc-950 sm:text-xl">
                  {headerTitle}
                </h1>
                <p className="mt-1 text-xs text-zinc-500">
                  Demo mode is local. Cloud sync, AI generation, checkout, and AR handoff activate only when their server keys are configured.
                </p>
                {invalidProjectParam ? (
        ...
        {activeId && activeProject ? (
          <header className="sticky top-0 z-[38] shrink-0 overflow-visible border-b border-zinc-200 bg-white/95 px-4 py-2.5 shadow-sm backdrop-blur sm:px-6 md:px-8">
            <div className="flex min-h-10 items-center justify-between gap-3">
              <h2 className="min-w-0 flex-1 truncate font-heading text-base font-semibold text-zinc-950 sm:text-lg">
                {activeProject.name}
              </h2>
              <div className="flex items-center gap-2">
                <div className="hidden shrink-0 items-center gap-1.5 rounded-lg border border-emerald-900/15 bg-emerald-50 px-2.5 py-2 text-xs font-medium text-emerald-950 sm:inline-flex">
                  <Cpu className="size-3.5 text-emerald-800" strokeWidth={2} />
                  Local demo
                </div>
                ...
                <button
                  ...
                  className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-xs font-medium text-zinc-800 shadow-sm transition-colors hover:border-zinc-300 hover:bg-zinc-50 sm:text-sm"
                >
                  <Users2 className="size-3.5 text-zinc-600" strokeWidth={2} />
                  Team
                </button>
              </div>
            </div>
        ...
        <main
          className={cn(
            "relative z-10 flex min-w-0 flex-col bg-[#f7f8f5]",
            activeId
        ...
        >
          ...
          {activeId ? (
                      ...
                      >
                        <div className="max-w-[min(100%,18rem)] rounded-2xl border border-zinc-800 bg-zinc-900/85 px-3 py-2">
                          <p className="text-[13px] leading-relaxed text-zinc-200">
                            Helix is drafting your updates
            ...
            <AnimatedAIChat
              placeholder="Describe the hardware you want Helix to generate…"
                  ...
                  <div className="py-14 text-center">
                    <p className="text-sm leading-relaxed text-zinc-600">
                      {projectSearch.trim()
                        ...
                        : "No projects yet. Start from Build, choose a template, or create a named project."}
                    </p>
            ...
            <div className="px-4 py-8 sm:px-6 md:px-10">
              <div className="mx-auto grid max-w-5xl gap-4 md:grid-cols-3">
                {[
                  ["MCU", "ESP32-S3, RP2040, STM32 footprints and firmware notes"],
                  ["Power", "USB-C input, buck regulators, protection, battery charging"],
                  ["Sensors", "Temperature, motion, light, distance, and environmental parts"],
                  ["Actuation", "Motors, servos, heaters, LEDs, haptics, and drivers"],
                  ["Connectors", "USB-C, JST, board-to-board, pogo, and test pads"],
                  ["Enclosures", "Bosses, ribs, vents, snap fits, gaskets, and AR scale checks"],
                ].map(([title, body]) => (
            ...
            <div className="px-4 py-8 sm:px-6 md:px-10">
              <div className="mx-auto max-w-3xl rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                <h2 className="text-lg font-semibold text-zinc-950">Manufacturing orders</h2>
                <p className="mt-2 text-sm leading-relaxed text-zinc-600">
                  Open a project and use the Manufacture tab to create a server-priced quote. Helix will show Stripe setup, payment state, and order history only when the required server configuration is present.
                </p>
              </div>
            </div>
          ) : tab === "Team" ? (
            <div className="px-4 py-8 sm:px-6 md:px-10">
              <div className="mx-auto max-w-3xl rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-relaxed text-zinc-600">
                  Collaboration is available inside each project. Supabase must be configured for persistent team membership, invites, and shared cloud projects.
                </p>
              </div>
            </div>
          ) : (
              ...
              <div className="mx-auto max-w-2xl">
                ...
                <div className="mt-6 rounded-2xl border border-white/[0.06] bg-white/[0.04] p-5">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-zinc-500">
                    ...
                    <span className="font-mono">HELIX_PYTHON</span> is set. Runs
                    ...
                    <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-white/[0.08] bg-white/[0.02] p-3 transition hover:border-white/[0.14]">
                      ...
                      <span>
                        ...
                        <span className="mt-0.5 block text-xs leading-relaxed text-zinc-500">
                          ...
                          if present, else{" "}
                          <span className="font-mono">HELIX_PYTHON</span> or{" "}
