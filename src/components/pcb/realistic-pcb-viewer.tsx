...
function BoardViewport({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "absolute inset-0 overflow-hidden bg-[#0b0a08]",
...
export function RealisticPCBViewer({
  ...
  return (
    ...
    >
      <div className="flex shrink-0 flex-wrap items-center justify-between gap-2 border-b border-white/[0.06] bg-[#0b0a08]/80 px-3 py-2 backdrop-blur-md sm:px-4">
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-basis-0 flex-col overflow-hidden">
        {activeTab === "schematic" && activeFile?.content?.includes("<svg") ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#0b0a08] p-4">
        ...
        {selectedComponent && (
          <div className="absolute right-3 top-3 z-20 max-w-xs rounded-lg border border-white/[0.1] bg-[#0b0a08]/95 p-3 text-zinc-300 shadow-xl backdrop-blur-md">
            {(() => {
