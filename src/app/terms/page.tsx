...
export const metadata: Metadata = {
  ...
  description: "Helix terms of service.",
};
    ...
    <main className="min-h-screen bg-[#0b0a08] font-sans text-zinc-100">
      ...
      <div className="mt-8 rounded-2xl border border-white/[0.06] bg-zinc-950/40 p-6 backdrop-blur-md sm:p-7">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-500">
          Helix is a demo interface for hardware-oriented “build in seconds”
        ...
        <section className="mt-6 space-y-5">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-500">
              To the maximum extent permitted by law, Helix and its contributors
