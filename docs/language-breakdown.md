...
- Handwritten Jac lines: 2,682
- Handwritten Next.js/TypeScript files: `app/page.tsx`, `app/layout.tsx`, `next-env.d.ts`
- Handwritten Next.js/TypeScript lines: 1,731
- Current executable application-code split, excluding CSS/config/docs/generated files: about 61% JaC and 39% Next.js/TypeScript by physical lines.
- The same split by source bytes is about 61% JaC and 39% TypeScript.
